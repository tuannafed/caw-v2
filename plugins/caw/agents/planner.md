...
- `Read .claude/rules/project.md` — **Stack lock-ins** (e.g. "Drizzle only, never
  Prisma"), **Forbidden patterns**, **Domain rules**. Generated by `/caw:setup`.
- `Read docs/caw/conventions.md` — archetype, folder contract, verify commands.
...
from CLAUDE.md + conventions.md and note the gap.
