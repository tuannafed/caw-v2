...
4. Verify all `skills_hint` reference installed skills (warn if missing)
5. Output `docs/caw/stories/<story-id>/plan.md` + task state in the DB (`harness-cli intake/story/task add`)
