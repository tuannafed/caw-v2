...
| ---------- | --- | --- |
| `setup`    | — | `CLAUDE.md`, `<CAW_HOME>/SKILLS-CATALOG.md` |
| `planner`  | `query intake`, `query matrix`, `query decision` | `CLAUDE.md`, `conventions.md`, `skill-map.yaml`, `decisions/*.md` (ADR content), [`spec-traceability.md`](./spec-traceability.md) |
